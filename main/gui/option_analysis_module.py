...
class OptionAnalysisConfig:
    ...
    def compare_sidebar(self):
        ...
        ttm_direction = st.sidebar.selectbox(
            "Time to Maturity threshold direction",
            ("above", "below"),
            help="Search for options above or below a certain threshold of time to maturity"
        )
    ...
    def compare_default(self):
        self.compare_sidebar()
        df = self.option_model_comparison()
    ...
    def option_model_comparison(self, ttm, otm, itm, ):
        data = {"ticker": "AAPL",
